...
def pandafy_tiffs(data_folder='../../AHN2_5m/',save_name='../../csv112/lat_lon_to_filename.csv',old_wkt=None, alice=False):
    '''
...
if __name__ == '__main__':
    if len(sys.argv) >= 2 and sys.argv[1] == 'grace':
        ...
        pandafy_tiffs(data_folder = "../../AHN2_5m/", save_name="../../csv112/lat_lon_to_filename.csv")
